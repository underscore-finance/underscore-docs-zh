...
我们最早从 [Hightop](https://hightop.com) 开始。Hightop 是基于 Underscore 构建的产品，它把面向 AI 代理的数字银行体验做得足够简单，供人类直接使用。其中最早的一条工作流，就是 Earn Autopilot：让闲置现金持续生息、监控市场、并将独立的[可编程钱包](user-wallet.md)再平衡到更好的收益机会。它确实能工作，但我们很快撞上了天花板：每一次优化都意味着要触碰每个钱包。如果我们想把同一套改进后的策略推广给 10,000 个用户，就意味着 10,000 笔独立交易。成本高、速度慢，而且 AI 代理在为想要同样结果的用户重复做同一份工作。
...
如今，Earn Vaults 已经上线，而核心 Vaults 与 Amplified Vaults 都已经在 Hightop 的实时收益体验中投入生产使用。
