...
你的资金仍然安全且可访问。智能合约是不可变的，不依赖 Underscore 的服务器。你仍然可以通过 BaseScan 或任何其他界面直接与钱包交互，也可以在 [Params Explorer](https://params.underscore.finance/deployments) 中查看当前部署与协议配置。
